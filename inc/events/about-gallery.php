<div class="about-gallery">
    ...
    <div class="about-thumbs">
    	...
    	<div class="contentGalleryWrapper">	
			<?php if( have_rows('galley_event') ): ?>
			    <?php while ( have_rows('galley_event') ) : the_row(); 
			        $gallery_img 	= get_sub_field('gallery_img');
			        $gallery_title 	= get_sub_field('gallery_img_title');
			        $gallery_video 	= get_sub_field('event_video');
			    ?>  
			    <?php if($gallery_img) { ?>
